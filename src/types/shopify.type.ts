...
export type ShopifyCartAutomaticDiscountAllocation =
...
export type ShopifyCartCodeDiscountAllocation =
  ShopifyCartDiscountAllocation & {
...
export type ShopifyPricingValue =
  | ShopifyMoneyV2
...
export type ShopifyCartDetailsFragment = {
  __typename?: "Cart";
  id: string;
  lines: {
    __typename?: "CartLineConnection";
    nodes: Array<{
      ...
      merchandise: {
        ...
        image?: { __typename?: "Image"; url: any; id?: string | null } | null;
        product: {
          __typename?: "Product";
          handle: string;
          id: string;
...
export type ShopifyCreateCartMutationVariables = Exact<{
  [key: string]: never;
}>;

export type ShopifyCreateCartMutation = {
  __typename?: "Mutation";
  cartCreate?: {
    __typename?: "CartCreatePayload";
    cart?: {
...
export type ShopifyCartDiscountCodesUpdateMutation = {
  __typename?: "Mutation";
...
export type ShopifyCartLinesRemoveMutation = {
  __typename?: "Mutation";
  cartLinesRemove?: {
    __typename?: "CartLinesRemovePayload";
    cart?: {
...
export type ShopifyGetLiteCartQuery = {
  __typename?: "QueryRoot";
  cart?: {
    __typename?: "Cart";
    id: string;
...
export type ShopifyGetAllCollectionsQuery = {
  __typename?: "QueryRoot";
  collections: {
    __typename?: "CollectionConnection";
    edges: Array<{
...
export type ShopifyGetAllCollectionsWithProductQueryVariables = Exact<{
  first: Scalars["Int"];
}>;

export type ShopifyGetAllCollectionsWithProductQuery = {
  __typename?: "QueryRoot";
  collections: {
    __typename?: "CollectionConnection";
    edges: Array<{
      ...
      node: {
        ...
        products: {
          __typename?: "ProductConnection";
          nodes: Array<{ __typename?: "Product"; id: string; handle: string }>;
        };
      };
    }>;
  };
...
export type ShopifyGetCollectionByIdQuery = {
  __typename?: "QueryRoot";
  collection?: {
    __typename?: "Collection";
    id: string;
...
export type ShopifyGetCollectionByIdWithProductsQuery = {
  __typename?: "QueryRoot";
  collection?: {
    __typename?: "Collection";
    id: string;
      ...
      edges: Array<{
        ...
        node: {
          ...
          images: {
            ...
            edges: Array<{
              __typename?: "ImageEdge";
              node: { __typename?: "Image"; id?: string | null; url: any };
            }>;
          };
          priceRange: {
            __typename?: "ProductPriceRange";
...
export type ShopifyGetByIdWithProductsHandleQueryVariables = Exact<{
  id: Scalars["ID"];
}>;

export type ShopifyGetByIdWithProductsHandleQuery = {
  __typename?: "QueryRoot";
  collection?: {
    __typename?: "Collection";
    products: {
...
export type ShopifyGetMenuByHandleQuery = {
  __typename?: "QueryRoot";
  menu?: {
    __typename?: "Menu";
    itemsCount: number;
...
export type ShopifyProductsDetailsFragment = {
  __typename?: "ProductConnection";
  edges: Array<{
    __typename?: "ProductEdge";
    node: {
...
export type ShopifyGetProductByHandleVariantBySelectedOptionsQueryVariables =
  Exact<{
    handle: Scalars["String"];
    selectedOptions:
      | Array<ShopifySelectedOptionInput>
      | ShopifySelectedOptionInput;
  }>;

export type ShopifyGetProductByHandleVariantBySelectedOptionsQuery = {
  __typename?: "QueryRoot";
  product?: {
    __typename?: "Product";
    id: string;
...
export type ShopifyGetNewArrivalsQuery = {
  __typename?: "QueryRoot";
  products: {
    __typename?: "ProductConnection";
    edges: Array<{
...
export type ShopifyGetProductsRecommendationsQuery = {
  __typename?: "QueryRoot";
  productRecommendations?: Array<{
    ...
    images: {
      ...
      edges: Array<{
        __typename?: "ImageEdge";
        node: { __typename?: "Image"; url: any; id?: string | null };
      }>;
    };
    priceRange: {
      __typename?: "ProductPriceRange";
    ...
    collections: {
      ...
      edges: Array<{
        __typename?: "CollectionEdge";
        node: { __typename?: "Collection"; id: string; handle: string };
      }>;
    };
  }> | null;
};
...
export type ShopifyGetProductVariantsByHandleQuery = {
  __typename?: "QueryRoot";
  product?: {
    __typename?: "Product";
    id: string;
